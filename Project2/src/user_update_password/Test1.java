...
public class Test1 {
	...
	public static void main(String[] args) throws MalformedURLException, ProtocolException, IOException {
		...
		URL url = new URL(Constant.USER_UPDATE_PASSWORD
				+ "?token=OiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwNzUyZjg4MjE5OWRkMDAxNTBjNDYzOSIsInVzZXJuYW1lIjoidHV5ZXRodDQwMTIiLCJyb2xlIjoibWFzdGVyIiwiaWF0IjoxNjE4MjkyNjUyLCJleHAiOjE2MTgzMTQyNTJ9.ZCSTQ5Qc8dSGt8d4JD72cUeqDD-bXRbhllWkwwdqhQ8"
