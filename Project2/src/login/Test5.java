...
public class Test5 {
	...
	public static void main(String[] args) throws MalformedURLException, ProtocolException, IOException {
		...
		System.out.println("thieu tham so password");
		URL url = new URL(Constant.LOG_IN + "?username=tuyetht123");
		...
		try (DataOutputStream writer = new DataOutputStream(connection.getOutputStream())) {
			...
			Gson g = new Gson();
			ResponseLogIn rp = g.fromJson(content.toString(), ResponseLogIn.class);
